...
void Tutorial02_Cube::CreateVertexBuffer()
{
    ...
    constexpr Vertex CubeVerts[16] =
    {
        // Base inferior (z = -1)
        {float3{1.0f, 0.0f, -1.0f}, float4{1.0f, 0.0f, 0.0f, 1.0f}},
        {float3{0.7071f, 0.7071f, -1.0f}, float4{0.0f, 1.0f, 0.0f, 1.0f}},
        {float3{0.0f, 1.0f, -1.0f}, float4{0.0f, 0.0f, 1.0f, 1.0f}},
        {float3{-0.7071f, 0.7071f, -1.0f}, float4{1.0f, 1.0f, 0.0f, 1.0f}},
        {float3{-1.0f, 0.0f, -1.0f}, float4{0.0f, 1.0f, 1.0f, 1.0f}},
        {float3{-0.7071f, -0.7071f, -1.0f}, float4{1.0f, 0.0f, 1.0f, 1.0f}},
        {float3{0.0f, -1.0f, -1.0f}, float4{0.2f, 0.2f, 0.2f, 1.0f}},
        {float3{0.7071f, -0.7071f, -1.0f}, float4{0.5f, 0.5f, 0.5f, 1.0f}},
